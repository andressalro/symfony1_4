...
;
// metodo call trae una url diferente a post o get
...
$job->save();
 // una vez que el puesto de trabajo se ha actualizado se recarga con refresh
$browser->
...
//simular envio de puesto de trabajo con token falso
$browser->
  get('/job/new')->
  click('Preview your job', array('job' => array(
    'token' => 'fake_token',
