...
//Otro
//echo getDateTimeObject('expires_at')->format('Y-m-d');
$job = create_job(array('expires_at' => '2020-12-03'));
$job->save();
$t->is($job->getDateTimeObject('expires_at')->format('Y-m-d'), '2020-12-03', '->save() does not update expires_at if set');
...
//Funcion utilizada crear un job
